...
function resizableGrid(table) {
  ...
  for (var i=0;i<cols.length;i++) {
   var div = createDiv(table.offsetHeight, i);
...
function createDiv(height, counter) {
 ...
 div.setAttribute('data-colnum', counter);
 return div;
}

function deleteDiv(height) {
	var divs = document.querySelectorAll("div.ql-table-resizable");
...
function setListeners(table, div) {
 ...
 div.addEventListener('mousedown', function (e) {
 	colnum = e.target.getAttribute('data-colnum');
	curCol = table.getElementsByTagName('col')[parseInt(colnum)];
	nxtCol = table.getElementsByTagName('col')[parseInt(colnum) + 1];
	pageX = e.pageX;
	curColWidth = curCol.width;
	if (nxtCol) {
		nxtColWidth = nxtCol.width;
	}
 });
